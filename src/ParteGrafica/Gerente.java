...
public class Gerente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Plato mas pedido");

        jButton2.setText("Mesero con mas ventas");

        jButton3.setText("Ventas por mesa");

        jButton4.setText("Alimentos que mas se usan");

        jButton5.setText("Alimentos que menos se usan");

        jButton6.setText("Total de ventas");
